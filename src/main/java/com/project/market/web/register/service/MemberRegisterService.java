...
public class MemberRegisterService {
    ...
    @Transactional
    public void register(MemberRegisterDto registerDto) {//회원가입
        validatePasswordCheck(registerDto);
        Member member = registerDto.toEntity(passwordEncoder);//비밀번호 인코딩
        memberService.register(member);
    }

    private void validatePasswordCheck(MemberRegisterDto registerDto) {//비밀번호 확인
